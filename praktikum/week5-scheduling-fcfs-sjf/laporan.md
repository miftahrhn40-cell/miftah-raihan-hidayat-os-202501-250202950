...
## Kode / Perintah
Gunakan tabel proses berikut sebagai contoh:
...
---
##TUGAS
Hitung waiting time dan turnaround time dari minimal 2 skenario FCFS dan SJF.
Sajikan hasil perhitungan dalam tabel perbandingan (FCFS vs SJF).
Analisis kelebihan dan kelemahan tiap algoritma.
Simpan seluruh hasil dan analisis ke laporan.md.
JAWABAN
...
- Bagaimana cara Anda mengatasinya?  tnya teman
